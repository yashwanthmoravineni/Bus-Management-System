        ...
        try {
            ...
            if (recordfound) {
                ...
                try {
                    ...
                    {
                        String temp = "INSERT INTO Schedules (Bus_No,bus_reg, Route_No, Route_Name,empNo,Driver_Name,Date_Scheduled,Trip_No,Dept_Time) VALUES ('" +
                        ...
                        String temp3 = "INSERT INTO TRIPS(Bus_regNo,Route_No,S_Date,Trip_No)VALUES('" +
                                cboRegNo.getSelectedItem() + "', '" +
                                cboRouteNo.getSelectedItem() + "' ,'" +
                                s_date.getText() + "' ,'" +
                                cboTrip.getSelectedItem() + "')";
                        int results1 = statement.executeUpdate(temp3);
